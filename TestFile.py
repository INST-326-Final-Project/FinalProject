...
class dframe:
    ...
    def calc_coefficient(self):
        ...
        """
        ## caluculating coefficients (linear regression) for data of Afghanistan 
        calc_df = self.df[self.df["Country"] == self.user_input] 
        X = calc_df[["Year",'Polio','Total expenditure','Schooling','Income composition of resources','Alcohol', 'Diphtheria ', 'Adult Mortality', 'Population']]
